...
if (tortoiseLocationX == 140 && tortoiseLocationY == 290) {
	JOptionPane.showMessageDialog(null, "Go to the parrots or the torch");	
}
...
if (tortoiseLocationX == 410 && tortoiseLocationY == 110) {
	JOptionPane.showMessageDialog(null, "Go to the robot");
	
}

if (tortoiseLocationX == 400 && tortoiseLocationY == 240) {
	JOptionPane.showMessageDialog(null, "Go to the bottle in the swamp");
